...
$('.checkbox-inner').find('input[type="checkbox"]').click(function () {
    var htm = '';
    //if ($(this).is(":checked")) {
    //    alert($(this).parent('.checkbox').text());
    ...
    $('.checkbox-inner').find('input[type="checkbox"]').each(function () {
        ...
        if ($(this).is(":checked")) {
            htm += $.trim($(this).parent('.checkbox').text());
            htm += ',';
...
function filter() {
    ...
    $('.checkbox-inner').find('input[type="checkbox"]').each(function () {
        ...
        if ($(this).is(":checked")) {
            checklist += $.trim($(this).parent('.checkbox').text());
            checklist += ',';
    ...
    $.ajax({
        ...
        url: TeamDetailPostBackURL,
        contentType: "application/json; charset=utf-8",
        data: { "college": college, "country": country, "city": city, "course": course, "ranklist": checklist, "shortlist": shortlist, },
        datatype: "json",
        success: function (data) {
