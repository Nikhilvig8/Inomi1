  ...
  $.fn.mDatatable = function(options) {
    ...
    var dt = {
      ...
      init: function(options) {
        ...
        if (options.data.type === "remote" || options.data.type === "local") {
          ...
          if (
            ...
            datatable.dataSet = datatable.originalDataSet = dt.dataMapCallback(
              options.data.source
            );
          }
          dt.dataRender();
      ...
      setupBaseDOM: function() {
        ...
        if (API.getOption("layout.height"))
          $(datatable.table).css("max-height", API.getOption("layout.height"));
                    ...
                    $(td)
                      ...
                      .html(
                        $("<a/>")
                          ...
                          .append(
                            $("<i/>").addClass(
                              API.getOption("layout.icons.rowDetail.collapse")
                            )
                          )
                      );
                  }
      ...
      paging: function(meta, callback) {
        var pg = {
          ...
          populate: function() {
            ...
            $.each(
              API.getOption("toolbar.items.pagination.pageSizeSelect"),
              function(i, size) {
                var display = size;
          ...
          paste: function() {
            ...
            $.each($.unique(API.getOption("toolbar.placement")), function(
              i,
              position
            ) {
              if (position === "bottom") {
          ...
          pagingBreakpoint: function() {
            ...
            // pagination update
            $.each(API.getOption("toolbar.items.pagination.pages"), function(
              mode,
              option
            ) {
        ...
        if (typeof detailCallback === "function") {
          ...
          var toggleSubTable = function(e) {
            ...
            if ($(detailRow).is(":hidden")) {
              ...
              $(datatable).trigger("m-datatable--on-collapse-detail", [
                parentRow
              ]);
            } else {
              ...
              $(datatable).trigger("m-datatable--on-expand-detail", [
                parentRow
              ]);
                ...
                .each(function(tdi, td) {
                  ...
                  if (typeof column !== "undefined") {
                    ...
                    if (
                      ...
                      // check if subtable toggle exist
                      if (
                        $(td).find(".m-datatable__toggle-subtable").length > 0
                      )
                        return;
                      // append subtable toggle
                      $(td)
      ...
      localDataUpdate: function() {
        ...
        if (typeof column !== "undefined") {
          if (typeof column.sortCallback === "function") {
            ...
            datatable.dataSet = dt.sortCallback(
              datatable.originalDataSet,
              sort,
              column
            );
    ...
    var API = {
      ...
      getColumn: function(columnName) {
        datatable.API.column = datatable.API.value = $(
          datatable.API.record
...
jQuery.validator.setDefaults({
  ...
  success: function(label, element) {
    $(label)
      ...
      .removeClass("has-danger"); // set success class to the control group
    $(label)
      .closest(".form-group")
    ...
    var menuOptions = {
      ...
      submenu: {
        desktop: {
          ...
          default:
            menu.data("menu-dropdown") == true ? "dropdown" : "accordion",
