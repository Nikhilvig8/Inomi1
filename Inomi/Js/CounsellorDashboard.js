...
$(document).ready(function () {
    ...
    $('#btnSearch').click(function () {
        ...
        document.location = '/CounsellorDashboard/CounsellorDashboard/?Str=' + StrMain;
    });
            ...
            $.ajax
                ({
                    ...
                    success: function (drr) {
                        ...
                        var url = "/CounsellorDashboard/CounsellorDashboard/?Str=" + Str + "&StrMain=" + StrMain;
...
$(document).ready(function () {
    ...
    //function reload_cart(CountryId) {

    //    $.ajax
    //        ({
    //            url: "/CounsellorDashboard/ApplicationChart?CountryId=" + CountryId + "",
    //            type: "Get",
    ...
    function reload_cart(ProductId, TabId) {
        ...
        $.ajax
            ({
                url: "/CounsellorDashboard/GetProductChartcounsellorDashboard?ProductId=" + ProductId + "&TabId=" + TabId + "",
                type: "Get",
                success: function (dataP) {
