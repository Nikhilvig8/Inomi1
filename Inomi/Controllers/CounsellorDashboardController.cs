...
{
    public class CounsellorDashboardController : Controller
    {
        // GET: CounsellorDashboard
        [SessionExpireAttribute]
        public ActionResult CounsellorDashboard(string str, string StrMain)
        {
            ...
            objStudent = DashboardCon.GetCounsellorDashboardStudentReport(str, UsertypeId);
        ...
        public ActionResult ApplicationChart(string CountryId)
        {
            var Model = new List<ProductChart>();
            DataTable dt = new DataTable();
            dt = StudentCon.ApplicationChart(CountryId);
        ...
        public ActionResult GetCounsellerPendingTask()
        {
            ...
            DataTable dt = new DataTable();
            dt = StudentCon.CounsellerPendingTaskById(UsertypeId);
        ...
        public ActionResult GetTotalAppliction()
        {
            ...
            var Model = new List<CounsellerPendingTask>();
            DataTable dt = new DataTable();
            dt = StudentCon.TotalApplictionById(UsertypeId);
        ...
        public ActionResult GetProductChartcounsellorDashboard(string ProductId, string TabId)
        {
            string UsertypeId = Session["UserTypeId"].ToString();
            var Model = new List<ProductChart>();
            DataTable dt = new DataTable();
            dt = StudentCon.ProductChartcounsellorDashboard(ProductId, TabId, UsertypeId);
